...
function MobileMenu({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      {/* Menu Panel */}
      <div className="absolute right-0 top-0 h-full w-80 bg-black/95 backdrop-blur-2xl border-l border-white/10 shadow-2xl">
        {/* Header */}
...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/50 backdrop-blur-lg">
        <div className="flex items-center justify-between w-full px-4 h-16">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <Button asChild size="sm">
              <Link
                href="/contact"
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-full px-4 py-2 text-sm transition-all duration-300"
              >
                Schedule A Call
              </Link>
            </Button>
