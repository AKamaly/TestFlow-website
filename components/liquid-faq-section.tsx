...
const faqs = [
    {
        question: "Do I need to be a LabVIEW or Python expert?",
        answer: "No. TestFlow reduces scripting overhead and makes workflows reusable and team-friendly.",
        meta: "Skills",
    },
    {
        question: "What instruments do you support?",
        answer: "We support common lab instruments via SCPI-based control. In the demo, we confirm your exact models and setup.",
        meta: "Compatibility",
    },
    {
        question: "How long does it take to see value?",
        answer: "Most teams automate 1–2 high-frequency tests first, then expand across the validation suite.",
        meta: "ROI",
    },
    {
        question: "Is this secure? What about deployment?",
        answer: "We support security-conscious teams. Deployment options can match your environment (details in the demo).",
        meta: "Security",
    },
    {
        question: "Can my whole team reuse flows?",
        answer: "Yes. Flows are designed to be shared, reviewed, and improved so knowledge stays with the team.",
        meta: "Collaboration",
    },
    {
        question: "How do we start?",
        answer: "Book a short demo. We’ll map one real test workflow from your lab and show the end-to-end automation.",
        meta: "Onboarding",
    }
];
...
const palettes = {
    ...
    light: {
        // Keeping light theme options just in case, though defaulting to dark
...
export function LiquidFaqSection() {
    const getRootTheme = () => "dark"; // Force dark theme for now to match site aesthetic
    ...
    `;
        ...
        return () => {
            // Don't remove the style to avoid flicker if component remounts quickly, or consider moving to global css if reused
        };
    }, []);
    ...
    // Determine toggle logic if we ever want to support light mode properly
    const toggleTheme = () => {
        // Keeping it simple for now, maybe toggle later if needed
    };
                ...
                <header className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
                    <div className="space-y-4">
                        ...
                        <h2 className={`text-3xl font-semibold leading-tight md:text-5xl ${palette.heading}`}>
                            Common questions about TestFlow.
                        </h2>
                        <p className={`max-w-xl text-base ${palette.muted}`}>
                            Everything you need to know about automating your bench, condensed into clarity.
                        </p>
                    </div>
                </header>
...
export default LiquidFaqSection;
