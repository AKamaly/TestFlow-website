...
.content .desc {
  ...
  max-width: 680px;
      ...
      {/* Header - Hidden since we use SiteHeader */}
      ...
      <main className="hero">
        <div className="max-w-5xl px-6">
          <div className="kicker">About TestFlow</div>
          <h1 className="title">
            We’re building the<br />
            operating system<br />
            for modern hardware validation.
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/contact">
              <button className="h-12 px-8 rounded-full bg-white text-black font-medium hover:bg-gray-100 transition-colors">
                Book a 15-Minute Demo
              </button>
            </Link>
            <Link href="/testflow-agent">
              <button className="h-12 px-8 rounded-full border border-white/20 hover:bg-white/10 transition-colors">
      ...
      <section className="content">
        ...
        <div className="heading">Built for validation engineers using real instruments</div>
        <p className="desc">
          Oscilloscopes, power supplies, SMUs, DMMs, and more.
        </p>
      </section>
    </section>
  );
