        ...
        <section className="py-16 md:py-32 bg-black text-white">
            <div className="mx-auto max-w-5xl space-y-12 px-6">
                <div className="relative z-10 grid items-center gap-4 md:grid-cols-2 md:gap-12">
                    <h2 className="text-4xl font-semibold text-white">The TestFlow ecosystem brings together our models</h2>
                ...
                <div className="relative rounded-3xl p-3 md:-mx-8 lg:col-span-3">
                    <div className="aspect-[88/36] relative">
                        ...
                        <img src="https://9zog2la6l29pbfba.public.blob.vercel-storage.com/Workflow%20builder%20AI%20powred.png" className="absolute inset-0 z-10 w-full h-full object-cover rounded-2xl" alt="TestFlow workflow builder" />
                    </div>
                </div>
